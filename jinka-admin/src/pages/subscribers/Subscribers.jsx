...
export const SubscribersList = () => {
    ...
    const fetchSubscribers = async () => {
        ...
        try {
            ...
            const msg = error?.response?.data?.message || error?.message || 'Failed to load subscribers';
            message.error(msg);
        } finally {
            setLoading(false);
        }
    ...
    const handleDelete = async (id) => {
        try {
            ...
            const msg = error?.response?.data?.message || error?.message || 'Failed to delete subscriber';
            message.error(msg);
        }
    };
